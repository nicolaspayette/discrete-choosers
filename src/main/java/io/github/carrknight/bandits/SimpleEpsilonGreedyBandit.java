...
/**
 * e-greedy algorithm where the options are just indices (that is 1,2,...,n) and you observe the
 * rewards directly (no need to transform)
 */
public class SimpleEpsilonGreedyBandit extends EpsilonGreedyBandit<Integer, Double, Object> {
     ...
     */
    public SimpleEpsilonGreedyBandit(
        int numberOfOptions,
     ...
     * @return
     */
    public static SimpleEpsilonGreedyBandit build(
        int numberOfOptions,
        long randomSeed, double epsilon,
        Supplier<? extends OneDimensionalFilter> memoryMaker
    ) {
        SimpleEpsilonGreedyBandit algo = new SimpleEpsilonGreedyBandit(
            numberOfOptions,
            randomSeed,
            epsilon
        );
     ...
     * @return
     */
    public static EpsilonGreedyBandit build(
        int numberOfOptions,
        long randomSeed, double epsilon,
        Supplier<? extends OneDimensionalFilter> memoryMaker,
