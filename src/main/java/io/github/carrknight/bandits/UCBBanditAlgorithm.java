...
public class UCBBanditAlgorithm<O, R, C> extends AbstractBanditAlgorithm<O, R, C> {
            ...
            optionsAvailable, randomizer, new LocalFilterSpace<>(
                ...
                new RewardFunction<O, R, C>() {
                    ...
                    public double extractUtility(
                        ...
                        double reward = rewardExtractor.extractUtility(
                            optionTaken,
                            experimentResult,
                            contextObject
                        );
                        reward = Math.min(
                            Math.max(reward, minimumRewardExpected),
                            maximumRewardExpected
                        );
                        return (reward - minimumRewardExpected) / (maximumRewardExpected
    ...
    /**
     * this is basically the bound generated by the Chernoff-Hoeffding inequality. The best
     * explanation for it is probably here: http://jeremykun
     * .com/2013/10/28/optimism-in-the-face-of-uncertainty-the-ucb1-algorithm/
     *
     * @return
     */
