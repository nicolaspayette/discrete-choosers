...
/**
 * nothing more than a facade/factory for the softmax bandit when it deals with indexed choices and
 * observes readily its rewards
 */
public class SimpleSoftmaxBanditAlgorithm extends SoftmaxBanditAlgorithm<Integer, Double, Object> {
     ...
     */
    public SimpleSoftmaxBanditAlgorithm(
        int numberOfOptions,
        long randomSeed
    ) {
        super(
    ...
    /**
     * creates a softmax bandit with temperature 1 that never decays but with a starting initial
     * expected reward to simulate initial optimism/pessimism
     *
     * @param randomSeed random seed
     */
    public SimpleSoftmaxBanditAlgorithm(
     ...
     * @param temperatureDecay      function called each time a decision is made in order to change
     *                              temperature (usually to lower it!)
     */
    public SimpleSoftmaxBanditAlgorithm(
        int numberOfOptions,
        long randomSeed,
