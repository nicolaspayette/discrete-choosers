...
/**
 * any object that given the last observation (which could be null) and the current best option
 * returns wheter or not to do something (usually whether to explore or not)
 *
 * @param <O>
 * @param <R>
 * @param <C>
