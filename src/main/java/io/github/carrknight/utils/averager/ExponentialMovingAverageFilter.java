...
/**
 * this is the standard Exponential moving average filter. There really isn't a good way to do
 * weights with it (the exponential part ought to do it) but what I'll do is simply turn the usual
 * EMA: old*(1-alpha) + new (alpha) into old * (1-w*alpha) + new * (w*alpha) kind of like an
 * eligibility trace. Of course it only makes sense for 0<=weight<=1
 */
