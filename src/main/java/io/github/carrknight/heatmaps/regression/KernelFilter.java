...
/**
 * If we assume the weight we get is a Kernel between here and wherever the observation comes from,
 * this is basically an iterative moving average with some forgetting
 */
