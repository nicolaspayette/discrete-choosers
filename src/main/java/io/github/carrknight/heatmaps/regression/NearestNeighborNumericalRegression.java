...
/**
 * nearest neighbour regression implemented by KD-Tree. Simple and scalable although with
...
public class NearestNeighborNumericalRegression implements NumericalRegression {
    ...
    /**
     * divide each feature similarity by this to reweight them. Strictly speaking these are copies
     * of the feature based distances, however we store them here because it makes the whole
     * regression object easier to tune!
     */
    ...
    /**
     * how do we judge the similarity between two nodes (this object basically just adapts our
     * similarity function \to the similarity function of the KD tree)
     */
    ...
    public double predict(double[] x) {
        ...
        MaxHeap<Double> neighbors = nearestNeighborTree.findNearestNeighbors(
            x,
            this.maxNeighbours,
            treeDistance
        );
