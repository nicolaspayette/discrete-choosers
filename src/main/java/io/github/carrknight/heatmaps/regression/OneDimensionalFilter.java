...
/**
 * this is basically any object that is like a very basic signal filter that keeps observing
 * Y_1,Y_2,\dots,Y_n and wants to predict what Y will be next time
 */
