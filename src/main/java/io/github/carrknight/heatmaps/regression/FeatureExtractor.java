...
/**
 * basic object that observes a pair of option,context and returns a number which represents one of
 * its features. For example, imagine the option being a cell in a grid, one feature extractor could
 * return its X value
 *
...
public interface FeatureExtractor<O, C> {
     ...
     * @return
     */
    double extract(O option, C context);
